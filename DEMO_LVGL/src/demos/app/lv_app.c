...
static void go_to_main(void) {
  lv_screen_load_anim(_main_screen, LV_SCREEN_LOAD_ANIM_MOVE_RIGHT,
                      ANIMATION_TIME, 0, false);
}
...
static void go_to_success(void) {
  ...
  lv_screen_load_anim(_success_screen, LV_SCREEN_LOAD_ANIM_MOVE_LEFT,
                      ANIMATION_TIME, 0, false);
}
...
static void success_create(void) {
  ...
  lv_obj_t *btn = lv_button_create(_success_screen);
